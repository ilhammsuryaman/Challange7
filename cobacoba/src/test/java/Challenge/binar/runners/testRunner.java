package Challenge.binar.runners;


import Challenge.binar.browserFactory;
import Challenge.binar.driverManager;
...
@CucumberOptions(features = "src/test/java/Challenge/binar/features",
        glue = "Challenge.binar.steps",
        tags = "",
        plugin = {
                "pretty",
